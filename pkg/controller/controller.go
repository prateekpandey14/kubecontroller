...
func NewCustomController(client *kubernetes.Clientset,
	secretInformer informercorev1.SecretInformer,
	namespaceInformer informercorev1.NamespaceInformer) *CustomController {
	c := &CustomController{
...
func (c *CustomController) Run(stop <-chan struct{}) {
...
func (c *CustomController) onAdd(obj interface{}) {
...
func (c *CustomController) onUpdate(oldObj, newObj interface{}) {
...
func (c *CustomController) onDelete(obj interface{}) {
...
func (c *CustomController) handleSecretChange(obj interface{}) {
...
func (c *CustomController) getSecretsInNS(ns string) ([]*apicorev1.Secret, error) {
...
func (c *CustomController) doSync() {
	log.Printf("here!")
...
func (c *CustomController) SyncNamespace(secrets []*apicorev1.Secret, ns string) {
